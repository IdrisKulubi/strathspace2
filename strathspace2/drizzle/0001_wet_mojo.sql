...
--> statement-breakpoint
ALTER TABLE "user" ALTER COLUMN "google_profile_data" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "user" ADD COLUMN "profile_completed" boolean DEFAULT false;--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "has_profile" boolean DEFAULT false;--> statement-breakpoint
